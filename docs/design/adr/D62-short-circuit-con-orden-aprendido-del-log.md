...
status: revised
revises: []
revised_by: [D167, D177]
---

# D62 — Short-circuit con orden aprendido del log

*(Revisada por D167: el orden aprendido del log se construye; el código lo
aprendía por invocación sin decisión. Revisada por D177: el corto-circuito
se retira; la fase evalúa el conjunto entero y nombra cada sorpresa.)* El engine evalúa los criterios del
