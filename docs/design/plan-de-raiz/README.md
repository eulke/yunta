...
| 9-03 | M32: un nodo que declara `scope:` abre su unidad y aterriza (D184); `OverlappingScope` y `OverlappingFanOutScope` pasan a ser load-bearing; el texto de `UndeclaredParallelScope` deja de prometer de más | 9-02, D184 | pendiente |
